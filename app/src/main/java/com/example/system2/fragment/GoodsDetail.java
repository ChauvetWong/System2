...
public class GoodsDetail extends Fragment implements View.OnClickListener {
    ...
    private GoodsInfo activity;
    private GoodsConfig goodsConfigFragment;
    private GoodsDetailWeb goodsDetailWebFragment;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.activity_goods_detail, null);
        initView();
        initListener();
        return rootView;
    }
    ...
    public void setData() {
        ...
        goodsDetailWebFragment = new GoodsDetailWeb();
