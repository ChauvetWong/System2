...
import com.example.system2.adapter.ItemRecommendAdapter;
import com.example.system2.adapter.NetworkImageHolderView;
import com.example.system2.bean.RecommendGoodsBean;
import com.example.system2.widgets.SlideDetailsLayout;
...
public class GoodsDisplay extends Fragment implements View.OnClickListener, SlideDetailsLayout.OnSlideDetailsListener {
    ...
    private float fromX;
    public GoodsConfig goodsConfigFragment;
    public GoodsDisplayWeb goodsInfoWebFragment;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.activity_goods_display, null);
        initView(rootView);
        initListener();
        initData();
        return rootView;
    ...
    public void setDetailData() {
        goodsConfigFragment = new GoodsConfig();
        goodsInfoWebFragment = new GoodsDisplayWeb();
    ...
    public void setLoopView() {
        ...
        imgUrls.add("https://img14.360buyimg.com/n0/jfs/t4867/58/973808559/58509/36edc4e9/58eb2322Nf0cc0f1a.jpg");
        imgUrls.add("https://img14.360buyimg.com/n0/jfs/t3076/313/363576345/163912/13b9c265/57b3d70eNbc6d89dc.jpg");
        imgUrls.add("https://img14.360buyimg.com/n0/jfs/t4249/74/2537429270/116868/228fdedb/58d3251cN4f663766.jpg");
        imgUrls.add("https://img14.360buyimg.com/n0/jfs/t4231/106/2544424512/134257/63a8b8b6/58d32523Na51f9c6d.jpg");
        imgUrls.add("https://img14.360buyimg.com/n0/jfs/t4372/2/2584419702/262411/830be368/58d32527N953b3046.jpg");
        //初始化商品图片轮播
